...
const spredseetController_1 = require("../controllers/spredseetController");
const spreadsheetRouter = (0, express_1.Router)();
spreadsheetRouter.use(auth_1.AuthMiddleware.verifyToken);
// ==========================================
 ...
 */
spreadsheetRouter.get("/peserta", spredseetController_1.SpreadsheetController.getPesertaData);
/**
 ...
 * GET /api/spreadsheet/summary
 */
spreadsheetRouter.get("/summary", spredseetController_1.SpreadsheetController.getSummary);
// ==========================================
 ...
 */
spreadsheetRouter.post("/create", spredseetController_1.SpreadsheetController.createSpreadsheet);
/**
 ...
 */
spreadsheetRouter.post("/create-by-month", spredseetController_1.SpreadsheetController.createSpreadsheetByMonth);
// ==========================================
 ...
 */
spreadsheetRouter.get("/download/excel/:spreadsheetId", spredseetController_1.SpreadsheetController.downloadExcel);
/**
 ...
 */
spreadsheetRouter.get("/download/pdf/:spreadsheetId", spredseetController_1.SpreadsheetController.downloadPDF);
// ==========================================
 ...
 * }
 */
spreadsheetRouter.post("/export/excel", spredseetController_1.SpreadsheetController.createAndDownloadExcel);
/**
 ...
 * }
 */
spreadsheetRouter.post("/export/pdf", spredseetController_1.SpreadsheetController.createAndDownloadPDF);
// ==========================================
 ...
 */
spreadsheetRouter.delete("/:spreadsheetId", spredseetController_1.SpreadsheetController.deleteSpreadsheet);
exports.default = spreadsheetRouter;
//# sourceMappingURL=spredseetRouter.js.map